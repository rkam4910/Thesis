...
data = readmatrix('pointcloud_20260311-152356_S.csv');
...
title('pointcloud\_20260311-153034\_ — Coloured by Amplitude');
...
xlabel('X (m)'); ylabel('Y (m)'); zlabel('Z (m)');
title('pointcloud\_20260311-153034\_ — Coloured by Height');
axis equal; grid on; view(45, 30);